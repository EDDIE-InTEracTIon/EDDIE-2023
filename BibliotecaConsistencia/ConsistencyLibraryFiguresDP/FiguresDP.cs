...
namespace ConsistencyLibraryFiguresDP
{
    public class FiguresDP : IFiguresDP
    {
        ...
        public JObject ObtenerFiguras(string nombrePDF, int pagePDF)
        {
            ...
            //ERROR: esta direccionado para el local de denisse 
            string newFile = "C:\\Users\\usuario\\Desktop\\respaldo-mesiva-ps\\eddie\\EDDIE-NewGUI2-2020-newGUI\\AugmentedReadingApp\\bin\\x86\\Debug\\temporal.pdf";
